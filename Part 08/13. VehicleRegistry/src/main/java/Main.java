...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        register.add(finnishPlates.get(0), "Amy");
        register.add(finnishPlates.get(1), "Chris");
        register.add(finnishPlates.get(0), "Miles");
        
        System.out.println(register.get(finnishPlates.get(0)));
    }
}
